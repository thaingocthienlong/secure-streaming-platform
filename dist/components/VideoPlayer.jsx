...
export default function VideoPlayer({ playbackId }) {
    ...
    return (<div className="aspect-video w-full rounded-lg overflow-hidden shadow">
      <MuxPlayer playbackId={playbackId} playback-token={playbackToken} streamType="on-demand" metadata={{ video_id: playbackId }} className="w-full h-full"/>
    </div>);
}
