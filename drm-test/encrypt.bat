@echo off
packager ^
  in=sample.mp4,stream=video,output=out/video_enc.mp4,segment_template=out/seg-$Number$.m4s ^
  in=sample.mp4,stream=audio,output=out/audio_enc.mp4,segment_template=out/audio_seg-$Number$.m4s ^
